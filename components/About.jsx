            ...
            <div className='flex-1'>
                ...
                <ul className='grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl'>
                    {infoList.map(({icon,iconDark,title,description},index) =>(
                        <li key= {index} className='border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-pink-50 hover:-translate-y-1 duration-500 shadow-2xs hover:inset-ring-2 inset-ring-black/50' >
                ...
                <h4 className='my-6 text-gray-700' style={{ fontFamily: "var(--font-ovo)" }}>
                    Tools i use
                </h4>
