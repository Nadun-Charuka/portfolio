     ...
     id='About' className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        transition={{duration:0.8}}
         className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
            ...
            className='w-64 sm:w-80 rounded-3xl max-2-none' >
            ...
            className='flex-1'>
                 ...
                 className='grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl'>
                    {infoList.map(({icon,iconDark,title,description},index) =>(
                        ...
                        whileInView={{scale:1.05}}
                         key= {index} className='border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-pink-50 hover:-translate-y-1 duration-500 shadow-2xs hover:inset-ring-2 inset-ring-black/50' >
                ...
                className='my-6 text-gray-700' style={{ fontFamily: "var(--font-ovo)" }}>
                    Tools i use
                </motion.h4>
                <motion.ul
                initial={{opacity:0}}
