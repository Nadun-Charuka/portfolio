     ...
     id="Work" className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        className='grid grid-cols-1  sm:grid-cols-2 lg:grid-cols-4 gap-6 my-10 '>
            {workData.map((project,index) => (
                ...
                className='aspect-square relative bg-no-repeat bg-cover bg-center rounded-lg  cursor-pointer group'
        ...
        href="" className='w-max flex items-center justify-center gap-2 text-gray-700 border-[0.5px] border-gray-700 rounded-full py-3 px-10 mx-auto my-20 hover:bg-pink-50 duration-500'>
